...
- If you use the [JHipster Registry]({{ site.url }}/bpmlabs-registry/), all instances of a gateway should automatically register themselves in a distributed cache
