...
Microservices are a type of JHipster applications, that have no front-end (the Angular front-end must be generated on a [gateway]({{ site.url }}/api-gateway/)), and which work with the [JHipster Registry]({{ site.url }}/bpmlabs-registry/) to be configured, discovered, and managed.
...
First, generate the entities in the microservices applications: this works as usual, and you can also use [JHipster UML]({{ site.url }}/bpmlabs-uml/) or [JDL Studio](https://bpmlabs.github.io/jdl-studio/) to help you generate complex entities and relationships. As microservices don't have a front-end, no Angular/React code will be generated.
