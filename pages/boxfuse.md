...
Image fused in 00:05.036s (96301 K) -> myuser/bpmlabs:1.0
Pushing myuser/bpmlabs:1.0 ...
Verifying myuser/bpmlabs:1.0 ...
...
Waiting for AWS to create an AMI for myuser/bpmlabs:1.0 in eu-central-1 (this may take up to 50 seconds) ...
...
Launching t2.micro instance of myuser/bpmlabs:1.0 (ami-35fa0b5a) in prod (eu-central-1) ...
...
Deployment completed successfully. myuser/bpmlabs:1.0 is up and running at http://bpmlabs-myuser.boxfuse.io:8080/</pre>
...
*   [Get Started with Boxfuse and JHipster](https://boxfuse.com/getstarted/bpmlabs)
*   [JHipster Boxfuse documentation](https://boxfuse.com/docs/payloads/bpmlabs)
